...
<%
	...
	if (admin_id != null && !admin_id.trim().isEmpty()) {
	    try {
	        ...
	        System.out.println("Invalid admin_id format: " + admin_id);
	    }
	} else {
	    System.out.println("admin_id is missing or empty.");
	}
    ...
    <div class="container">
        ...
        %>
            <div class="card">
                ...
                <div class="actions">
                    <a href="/CarManagement/View/bookVehicle.jsp?vehicle_id=<%= vehicle.getVehicle_id() %>" class="btn edit-btn">Book Vehicle</a>
